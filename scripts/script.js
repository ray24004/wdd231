...
const courseButtonsParent = document.querySelector("#courseButtons");
...
courseButtonsParent.innerHTML = "";
courses.forEach(c => {
    const newButton = document.createElement("button");
    newButton.textContent = `${c.subject} ${c.number}`;
...
const courseButtons = document.querySelectorAll("#courseButtons > button");
courseTypeButtons.forEach(b => {
    b.addEventListener("click", e => {
        courseButtons.forEach(c => {
            const isMatch = b.textContent === "All" || c.textContent.includes(b.textContent);
